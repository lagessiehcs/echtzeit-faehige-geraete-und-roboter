...
#define TIM_CCR1_OFFSET 0x034 // Für Timer 2 und 5
...
#define TIM_CCR1(timer_base) REG32(timer_base + TIM_CCR1_OFFSET) // Für Timer 2 und 5
...
void TIM_ConfigCompareMode(uint32_t timer_base);            // Für Timer 2 bis 5
void TIM_SetCompareValue(uint32_t timer_base, int compare); // Für Timer 2 bis 5
